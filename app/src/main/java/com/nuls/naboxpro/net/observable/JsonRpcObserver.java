...
import com.nuls.naboxpro.jsbridge.EthCallResponse;
...
public abstract class JsonRpcObserver<T> implements Observer<ResponseBody>, ObserverResponseListener<T>, ProgressCancelListener {

    private ProgressDialogHandler mProgressDialogHandler;
    private Disposable d;
    Context context;

    public JsonRpcObserver(Context context) {
        this(context, true, true);
    }

    public JsonRpcObserver(Context context, boolean isDialog, boolean cancelable) {
    ...
    public void onNext(ResponseBody t) {
        ...
        try {
            response = t.string();
            EthCallResponse result = new Gson().fromJson(response, EthCallResponse.class);
