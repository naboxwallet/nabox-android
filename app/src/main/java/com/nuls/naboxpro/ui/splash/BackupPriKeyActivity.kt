...
import kotlinx.android.synthetic.main.activity_new_back_up.*
import kotlinx.android.synthetic.main.base_title_layout.*
import network.nerve.core.crypto.HexUtil

class BackupPriKeyActivity:BaseActivity() {
    override fun getLayoutId() = R.layout.activity_new_back_up
    ...
    companion object{
        ...
        fun start(context: Context, colorIndex:Int,password:String, naboxAccount: NaboxAccount, alias:String?=null){
            var intent: Intent = Intent(context,BackupPriKeyActivity().javaClass)
    ...
    private fun walletSync(){
        ...
        RetrofitClient.getInstance().invokePostBody(this,Api.WALLET_SYNC, walletSyncRequestEntity).subscribe(object :RecObserver<BaseResponse<Any>>(this,true,false,Api.WALLET_SYNC){
            override fun onSuccess(t: BaseResponse<Any>?) {
               //同步成功。将钱包信息存入本地数据库
                ...
                startActivity(Intent(this@BackupPriKeyActivity, MainMenuActivity().javaClass))
